  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#222328] text-[14px] max-w-[500px]">**IMPORTANT** The App uses a free server, it can require you to reload the page after some minutes to see the images load, sorry for the inconvenience</p>
